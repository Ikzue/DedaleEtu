...
import eu.su.mas.dedaleEtu.mas.agents.dummies.TankerMultiAgent;
...
import old.DummyCollectorAgent;
import old.DummyMovingAgent;
import old.DummyTankerAgent;
...
public class Principal {
	...
	public static void main(String[] args){
		...
		if(ConfigurationFile.COMPUTERisMAIN){
			...
			// pour utiliser sniffer et rajuster la position de graphe
...
//		  agentList.add(ag);
		 ...
		 * entities file. agentName="Explo2";
		 * 
		 * //3) If you want to give specific parameters to your agent, add them here
		 * Object [] entityParameters3={"My parameters"};
		 * 
		 * //4) Give the class name of your agent to let the system instantiate it
		 * ag=createNewDedaleAgent(c, agentName, ExploreMultiAgent.class.getName(),
		 * entityParameters3); agentList.add(ag);
		 */
		/*********
		 * AGENT Collect 1
		 *********/
		...
		//4) Give the class name of your agent to let the system instantiate it
		ag=createNewDedaleAgent(c, agentName, CollectorMultiAgent.class.getName(), entityParametersC);
		agentList.add(ag);	
//		//1) Get the container where the agent will appear
//		c = containerList.get(ConfigurationFile.LOCAL_CONTAINER2_NAME);
//		Assert.assertNotNull("This container does not exist",c);
...
//		
//		//4) Give the class name of your agent to let the system instantiate it
//		ag=createNewDedaleAgent(c, agentName, CollectorMultiAgent.class.getName(), entityParametersC2);
//		agentList.add(ag);	
//		//1) Get the container where the agent will appear
//		c = containerList.get(ConfigurationFile.LOCAL_CONTAINER2_NAME);
//		Assert.assertNotNull("This container does not exist",c);
...
//		
//		//4) Give the class name of your agent to let the system instantiate it
//		ag=createNewDedaleAgent(c, agentName, CollectorMultiAgent.class.getName(), entityParametersC3);
//		agentList.add(ag);	
		/***************
		 * AGENT Tanker
		 ***************/
